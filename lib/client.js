window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		function updateSessionCompress(sessionId, enabled) {
			return request("/api/dsh-project-memory/session", {
				method: "PUT",
				body: JSON.stringify({
					sessionId,
		...
		*/
		...
		function SessionMemorySwitch(props) {
			...
			const [compressOn, setCompressOn] = (0, react.useState)(true);
			const [compressInterval, setCompressInterval] = (0, react.useState)(5);
			const [busy, setBusy] = (0, react.useState)(false);
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [error !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						...
						className: memory_module_css_default.dockRows,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
							...
							className: memory_module_css_default.dockLabel,
							title: compressOn ? t("switch.compressHintOn", { interval: compressInterval }) : t("switch.compressHintOff"),
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: memory_module_css_default.dockHint,
								children: compressOn ? t("switch.compressLabel") + " · " + t("switch.on") : t("switch.compressLabel") + " · " + t("switch.off")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
								type: "checkbox",
								role: "switch",
								className: memory_module_css_default.switch,
