...
function resolveTemplateDir(home = process.env.DSH_HOME ?? homedir()) {
	const user = defaultSkillDir(home);
...
function loadSkillContent(home = process.env.DSH_HOME ?? homedir()) {
...
function configPath(home = process.env.DSH_HOME ?? homedir()) {
